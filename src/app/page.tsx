...
import { Search, Loader2, Sparkles, LogIn, GitMerge, Settings } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 flex flex-col min-h-screen">
      ...
      {/* Admin Footer Link */}
      <footer className="mt-20 border-t border-gray-100 pt-6 flex justify-center">
        <Link href="/admin" className="flex items-center gap-2 text-xs text-gray-400 hover:text-indigo-600 transition">
          <Settings className="w-3.5 h-3.5" /> Super Admin Dashboard
        </Link>
      </footer>
    </main>
  );
